...
public class TitleEndButton extends Task {
    private Bitmap  bmp; // 画像
    private Rect    dst; // 描画範囲

    // コンストラクタ
    public TitleEndButton(Context cont) {
        bmp = Utility.readBitmap(cont, "t_ed");
    }
    ...
    public void onDrawView(Graphics gr) {
        ...
        gr.drawBitmap( bmp
                      ...
                      ,Const.HEIGHT-gr.getOriginY()-(bmp.getHeight()+10)); //+10は余白
        // 描画した範囲の取得
        dst = gr.getDstRect();
    }
